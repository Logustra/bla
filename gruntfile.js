module.exports = function(grunt){
  ...
  var sassFiles = [
    "dist/builds/sass/*.scss",
    "dist/builds/sass/base/*.scss",
    "dist/builds/sass/modules/*.scss",
    "dist/builds/sass/pages/*.scss",
    "dist/builds/sass/layout/*.scss"
  ];
  ...
  grunt.initConfig ({
    ...
    sass: {
      ...
      dev: {
        files: {
          "dist/builds/css/styles.css": [sassFiles]
        }//files
      }//dist
    },//sass
